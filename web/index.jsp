...
<html>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark">
      <a class="navbar-brand" href="#">Softwater</a>
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            <a id="dropdownProducts" class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Products
            </a>
            <div class="dropdown-menu" aria-labelledby="dropdownProducts">
              <a class="dropdown-item" href="#">Freechat</a>
              <a class="dropdown-item" href="#">Wys</a>
            </div>
          </li>
        </ul>
      </div>
